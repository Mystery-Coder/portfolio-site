...
function App() {
	...
	return (
		<>
			...
			{/* Hero Section */}
			<div className="flex flex-col items-center text-center p-38 transition-colors duration-300 dark:bg-gray-800">
				<img
					src="/me.webp"
					alt="Srikar"
				...
				<h1 className="text-5xl sm:text-7xl font-bold text-gray-900 dark:text-white  mb-4">
					Hi, I'm <span className="text-blue-700">Srikar</span>
				</h1>
